...
<body style="margin-right: 40px; margin-left: 40px">
    <h3 style="padding-top: 20px" class="text-center">Laporan Pengiriman CASH</h3>
    <h3 class="text-center">Java Express</h3>
    <p>Total : <?php echo count($pengiriman) ?></p>
  ...
  <tbody>
    ...
    <?php foreach ($pengiriman as $data): ?>
      <tr>
        ...
        <?php $total_biaya_kirim += $data['biaya_kirim'] ?>
      </tr>
    <?php endforeach ?>
    <tr>
      <td colspan="4"></td>
